...
Images.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, filename, width, height, images;
        ...
        switch (_b.label) {
            case 0:
                ...
                res.status(400).render('index', {
                    errorMessage: 'You must provide a file name, a width and a ' +
                        'height to process image resizing'
                });
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, imagePocessing_1.default(filename, parseInt(width), parseInt(height))];
            case 2:
                images = _b.sent();
